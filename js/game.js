...
var selectTextDisplay = 'Chọn [NUMBER] số'; //select number text display
...
var prizeTableDisplay = 'Bảng Điểm'; //score table text display
var numberTextDisplay = 'Số của bạn'; //your score text display
var matchTextDisplay = 'Giải [NUMBER]'; //match text display
var scoreTextDisplay = '[NUMBER] Xu'; //prize score text display

var score_arr = [50,100,500,1000,10000,100000]; //score points array

var bonusBall = true; //toggle bonus ball
var bonusTextDisplay = 'Giải [NUMBER] + BONUS'; //match bonus text display
var bonusScore = [50000]; //bonus score point

var exitMessage = 'BẠN CÓ CHẮC\nBẠN KHÔNG MUỐN NHẬN THƯỞNG?'; //go to main page message
var resultCompleteText = 'BẠN ĐÃ THẮNG [NUMBER] Xu!'; //result complete text display
var resultFailText = '0 CÓ XU NÀO!';  //result fail text display

//Social share, [SCORE] will replace with game score
var shareEnable = true; //toggle share
var shareText = 'CHIA SẺ FACEBOOK ĐỂ NHẬN QUÀ TỪ AG'; //social share message
var shareTitle = 'TUI MỚI QUAY ĐẠT ĐƯỢC [SCORE] XU NÈ.';//social share score title
var shareMessage = 'XU CÀNG CAO ĐỔI QUÀ CÀNG LỚN. QUAY TIẾP NÀO!'; //social share score message
