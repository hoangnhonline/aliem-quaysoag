...
$data = array("name","email","type","score","phone");
...
$enableLevel = isset($_REQUEST['enableLevel']) == 1 ? $_REQUEST['enableLevel'] : '';
if($dataIsset == $data_length){
	...
	if($enableLevel){
		...
		$result = mysqli_query($conn, "SELECT * FROM $table WHERE email='$data_val[1]'");	
	}
